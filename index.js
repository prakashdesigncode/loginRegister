...
mongoose
  .connect(
    "mongodb+srv://prakash:SlSkzV0LwisOYuUa@cluster0.g1mhn.mongodb.net/write-exam"
  )
...
server.get("/submittedStatus", async (req, res) => {
  try {
    ...
    console.log(questions.length, withoutAnswer.length, withoutAnswer);
    if (questions.length === withoutAnswer.length) {
